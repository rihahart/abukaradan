    ...
    <div className="min-h-screen bg-black text-neutral-100 antialiased">
      ...
      <section className="relative min-h-[100svh] w-full overflow-hidden">
        <img
          ...
          className="absolute inset-0 h-full w-full object-cover object-[70%_center] md:object-[60%_center] lg:object-[50%_center] xl:object-[45%_center] min-[1600px]:object-[45%_8%] min-[1900px]:object-[45%_4%]"
        />
